        ...
        <div className="photo-section-child">
          ...
          <div className="photo-section-bottom dynamic-margin">
            <div className="photo-section-description">
              every time you pay your credit card bills on ALUMA, you receive
              ALUMA coins. you can use these to win exclusive rewards or get
              special access to curated products and experiences. on ALUMA, good
              begets good.
            </div>
