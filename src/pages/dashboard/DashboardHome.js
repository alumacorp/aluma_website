        ...
        <div class="h-screen hidden lg:block shadow-lg relative w-80">
          <div class="bg-white h-full dark:bg-gray-700">
            <div class="flex items-center justify-start pt-6 ml-8">
              <p class="font-bold dark:text-white text-xl">Aluma</p>
            </div>
            <nav class="mt-6">
              <div>
                <a
                ...
                >
                  ...
                  <span class="mx-2 text-sm font-normal">Analytics</span>
                </a>
                <a
                  class="w-full text-gray-400 flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start hover:text-gray-800 border-l-4 border-transparent"
                  href="#"
                >
                  ...
                  <span class="mx-4 text-sm font-normal">Manage Barbers</span>
                </a>
                <a
                  class="w-full text-gray-400 flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start hover:text-gray-800 border-l-4 border-transparent"
                  href="#"
                >
                  ...
                  <span class="mx-4 text-sm font-normal">Bookings</span>
                </a>
              </div>
            </nav>
          </div>
        ...
        <div class="flex flex-col w-full md:space-y-4">
          ...
          <div class="overflow-auto h-screen pb-24 px-4 md:px-6">
            ...
            <h2 class="text-md text-gray-400">
              Here&#x27;s what&#x27;s happening with all shops today.
            </h2>
            ...
            <div class="container mx-auto px-4 sm:px-8 max-w-10xl text-white">
              <div class="py-8">
                <div class="flex flex-row mb-1 sm:mb-0 justify-between w-full">
                  <h2 class="text-2xl leading-tight">Shops</h2>
                  <div class="text-end">
